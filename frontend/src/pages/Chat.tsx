...
export function Chat() {
  ...
  const [hasMessages, setHasMessages] = useState(false); // Start empty for demo purposes
        ...
        <div className="max-w-4xl mx-auto space-y-8 pb-12 h-full flex flex-col">
          ...
          {!hasMessages ? (
            <div className="flex-1 flex items-center justify-center">
              <EmptyState 
                title={persona === 'sudo' ? "ROOT TERMINAL READY" : persona === 'titan' ? "Titan Command Center" : "How can I help you today?"}
                description={persona === 'sudo' ? "Awaiting system commands. Elevated privileges active." : "I can control your apps, summarize files, or answer questions."}
                icon={<MessageSquare className="w-8 h-8" />}
                action={{
                  label: "Load Example Conversation",
